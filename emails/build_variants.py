...
def _b_callout(eyebrow, title, body, inset='', cta=''):
    ...
    return (f'<table width="100%" cellpadding="0" cellspacing="0" class="ann" style="background-color:#0D0E10;background-image:url(va/callout-bg.jpg);background-size:cover;background-position:center;border:1px solid #232323;border-radius:10px;"><tr><td class="ann-i" style="padding:26px 28px;font-family:{_F};">'
            ...
            f'<div class="anntl" style="font-size:24px;font-weight:500;color:#ffffff;line-height:1.35;margin:0 0 10px;">{title}</div>'
...
TIP_CARD = _b_callout(
    ...
    <table width="100%" cellpadding="0" cellspacing="0" class="pbox-w" style="background-color:#2b2b2b;background-image:radial-gradient(circle at top left,#8FD0FF 0%,#4DA6FF 6%,#1488FC 11%,#2b2b2b 24%);border-radius:12px;"><tr><td style="padding:2px;">
      <table width="100%" cellpadding="0" cellspacing="0" class="pbox" style="background:#1E1F22;border-radius:10px;"><tr><td class="pbx-t" style="padding:16px 18px 14px;font-family:{_F};font-size:13px;line-height:1.42;color:#E8E8EA;">
...
<style>
  ...
  @media (max-width:480px) {{
    ...
    .anntl {{ font-size:22px !important; line-height:1.3 !important; }}
...
_OGS = """
  ...
  [data-ogsc] .c-head, [data-ogsc] h1 { color:#ffffff !important; }
...
<table class="wrap" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">
  ...
  <tr><td bgcolor="#ffffff" class="px k-light ec" style="background:#ffffff;padding:24px 36px 36px;font-family:{_F};">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" class="tipcard" style="background:#FFFFFF;border:1px solid #E2E0DC;border-radius:10px;margin:36px 0 0;"><tr><td class="tc-i" style="padding:26px 28px;font-family:{_F};">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" class="pbx" style="background:#1E1F22;border-radius:10px;"><tr><td class="pbx-t" style="padding:16px 18px 14px;font-family:{_F};font-size:13px;line-height:1.42;color:#E8E8EA;">
        Using the Stripe connector, create a new product called Pro Plan at $29/month in test mode, then add a checkout flow for it to my app with success and cancel pages.
      </td></tr>
      <tr><td style="padding:0 12px 12px;">
        <table width="100%" cellpadding="0" cellspacing="0"><tr>
...
const SIM = `<script>(function(){
  ...
  els.forEach(function(el){ if(!el||el.tagName==='IMG') return;
    ...
    if(MODE==='gmail') return;  /* real Gmail leaves border colors alone */
